...
\begin{figure}
\includegraphics[scale=0.4]{KrypCalFigs/S1abS2_sumpod_040317_2.png}
...
\begin{figure} [!h]
\centering
\subfloat{{\includegraphics[width=7cm]{KrypCalFigs/S1aS1bCut_Timing_1.png} }}
\qquad
\subfloat{{\includegraphics[width=7cm]{KrypCalFigs/S1aS1bCut.png} }}
...
\begin{center}
\includegraphics[scale=0.4]{KrypCalFigs/S1aS1bvField_ZDep_3D_S2Only.png}
...
\begin{figure}
\includegraphics[scale=0.4]{KrypCalFigs/S1aS1bvField_ZDep_3D.png}
...
\begin{center}
\includegraphics[scale=0.4]{KrypCalFigs/MatthewS1FieldEffectMeasurement.png}
...
\begin{center}
\includegraphics[scale=0.4]{KrypCalFigs/StrengthOfFieldEffectOverlay.png}
