...
\begin{figure}
\centering
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/KrEnergy.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/KrEnergyZDep.png} }}
...
\begin{figure}
%\includegraphics[scale=0.4]{KrypCalFigs/KrypCal_2p22_AllCH3TEnergy.png}
\includegraphics[scale=0.4]{KrypCalFigs/CH3T_energy_wres_sep2015.png}
...
\begin{center}
\includegraphics[scale=0.4]{KrypCalFigs/LUX_eLifetime_Kr2p22.png}
...
\begin{figure}
\centering
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/NRband_run3.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/NRband_run4.png} }}
...
\begin{figure} 
\centering
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/Sep2015_VoxelizedBands_WithUpperLower.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/OverlayOfAllERBands.png} }}
...
\begin{figure} 
\centering
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/PowerLawExponent.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{KrypCalFigs/PowerLawCoefficient.png} }}
...
\begin{center}
\includegraphics[scale=0.45]{KrypCalFigs/Feb2016_ERPrediction.png}
