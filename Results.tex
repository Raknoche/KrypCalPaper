...
\begin{figure}
\centering
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig8a.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig8b.png} }}
...
\includegraphics[scale=0.4]{figures/Fig9.png}
...
\begin{center}
\includegraphics[scale=0.4]{figures/Fig11.png}
...
\begin{figure}
\centering
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig12a.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig12b.png} }}
...
\begin{figure} 
\centering
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig13a.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig13b.png} }}
...
\begin{figure} 
\centering
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig14a.png} }}
\qquad
\subfloat{{\includegraphics[width=6.5cm]{figures/Fig14b.png} }}
...
\begin{center}
\includegraphics[scale=0.45]{figures/Fig15.png}
